using Sausio_25_d_pamoka.   Models;
using System;
using System.Collections.Generic;
using System.IO;

namespace BookSavingInExternalTxtFile

{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            BookSavingInExternalTxtFile();




            static void BookSavingInExternalTxtFile()
            {
                /*1. Book entity
                2. Books repository
                3. Repository  saves a book in a file*/

                /* 1. Check if such a book already exists, if so add a counter to an existing one (For example a book is saved like this "LotR III"
                ...
                {
                    Console.Clear();
                    Console.WriteLine("Welcome To Book storage");
